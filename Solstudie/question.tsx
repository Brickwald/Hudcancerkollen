...
export default class NumQuestion extends React.Component {
        ...
        return (
            <div>
                ...
                <div style={inputStyle}>
                    <input type="number" ref={this.inputRef} onChange={this.props.handleChange(this.props.step - 1)} value={this.props.answer} onKeyPress={this.checkEnterPress} />
                </div>
